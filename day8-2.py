...
def calc_signal_pos(angle, distance, starting_point):
    # numpy x,y is diff
    x = starting_point[1] + (distance) * math.cos(math.radians(angle))
    y = starting_point[0] + (distance) * math.sin(math.radians(angle))
